...
import 'package:seu_projeto/app/views/desktop/form/sucesspage_desktop.dart';
...
class MailFormDesktop extends StatefulWidget {
  @override
  _MailFormMobile createState() => _MailFormMobile();
}

class _MailFormMobile extends State<MailFormDesktop> {
  ...
  Future<void> _enviarFormulario() async {
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => SucessPageDesktop()),
      );
    } catch (error) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ErroPageDesktop()),
      );
