...
class ErroPageDesktop extends StatelessWidget {
  const ErroPageDesktop({Key? key}) : super(key: key);
          ...
          Center(
            child: ElevatedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => HomeDesktop()),
                );
              },
              child: Container(
                width: 100,
...
class SucessPageDesktop extends StatelessWidget {
  const SucessPageDesktop({Key? key}) : super(key: key);
